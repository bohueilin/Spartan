...
import com.vitalcompass.domain.model.ClinicalRange
...
class MetricEngine {
    ...
    fun assess(reading: MetricReading, target: TargetValue? = null): MetricAssessment {
        ...
        return MetricAssessment(
            ...
            clinicalMessage = clinicalMessage(reading, clinicalStatus),
            targetMessage = targetMessage(reading, targetStatus),
        )
    }
